...
export class SearchManager {
    ...
    performSearch() {
      ...
      if (pageState && pageState.searchOptions) {
        ...
        } else if (this.currentPage === 'loras' || this.currentPage === 'outputs' || this.currentPage === 'checkpoints' || this.currentPage === 'embeddings') {
            // Update only the relevant fields in searchOptions instead of replacing the whole object
      ...
      } else if (this.currentPage === 'loras' || this.currentPage === 'outputs' || this.currentPage === 'embeddings' || this.currentPage === 'checkpoints') {
